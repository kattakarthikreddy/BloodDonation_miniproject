function bbRegistrationValidation()
{
...
var phone = document.f4.t7.value;
	if(phone == "")
	{
    ...
    var email = document.f4.t6.value;
	var apos=document.f4.t6.value.indexOf("@");
	var dotpos=document.f4.t6.value.lastIndexOf(".");
    ...
    var district = document.f4.d3.value;
	if(district == "")
	{

		errorMsg += "\nDISTRICT Select district \n";
	}
    var address = document.f4.m1.value;
	if(address == "")
	{
     ...
     var area = document.f4.d4.value;
	if(area == "")
	{
    
		errorMsg += "\nArea: Enter Area\n";
	}
    var username=document.f4.t3.value;
	var password=document.f4.t4.value;
	var repassword=document.f4.t5.value;
...
if (errorMsg != "")
	...
	{
        document.f4.method="post";
        document.f4.action="bb.jsp";
        document.f4.submit();
		return true;
	}
